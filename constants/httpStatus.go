...
var HTTPStatusMap = map[string][]string{
	HTTP_GET:     defaultHTTPStatus,
	HTTP_POST:    postHTTPStatus,
	HTTP_PUT:     putHTTPStatus,
	HTTP_DELETE:  deleteHTTPStatus,
	HTTP_OPTIONS: defaultHTTPStatus,
	HTTP_HEAD:    defaultHTTPStatus,
	HTTP_PATCH:   defaultHTTPStatus,
}
